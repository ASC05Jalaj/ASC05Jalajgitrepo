...
public class TBookEntity {
    ...
    public TBookEntity(String id, String passenger, String phoneNumber, String pickup, String destination, String status, String bookingDate, String bookingTime, String model, CabsEntity cab) {
        this.id = id;
